{
  "ai_readiness_assessment": {
    ...
    "assessment_result": {
      ...
      "strategy_rationale": "All category bands are Low; solopreneur and budget modifiers apply. Prioritize lowest complexity, quick-win strategies (efficiency, productivity) for immediate impact and low risk. Higher-complexity strategies are not recommended due to foundational constraints.",
      "roadmap": {
        "phase_1_quick_wins": [
          {
            "title": "Automate Simple Tasks with Free Tools",
            "why": "Reduces manual workload and saves owner time for other priorities",
            "actions": [
              "Identify repetitive admin tasks (e.g., invoicing, scheduling)",
              "Choose one free/low-cost tool for automation",
              "Set up tool integrations (email, calendar, or accounting)",
              "Pilot with one process for two weeks"
            ],
            "effort": "S",
            "owner": "Owner",
            "duration_weeks": 2,
          ...
          {
            "title": "Template Routine Communications",
            "why": "Ensures consistent messaging and streamlines customer responses",
            "actions": [
              "List top 3-5 frequent client emails/messages",
              "Draft or reuse standard response templates",
              "Test in daily communication for two weeks",
          ...
          {
            "title": "Track Key Business Metrics in a Spreadsheet",
            "why": "Establishes a basic system for decision-making without extra costs",
            "actions": [
              "Select 3 simple metrics (e.g., revenue, customer contacts, costs)",
              "Create/update a spreadsheet for weekly tracking",
              "Set a 10-minute weekly review routine",
              "Note any trends or pain points"
            ],
            "effort": "S",
            "owner": "Owner",
            "duration_weeks": 2,
        ...
        "phase_2_3_6_months": [
          {
            "title": "Implement AI-Based Productivity Tool",
            "why": "Augments daily work capacity with minimal effort",
            "actions": [
              "Review affordable AI tools for reminders, emails, or social posting",
              "Test one tool for a core workflow (e.g., AI email responder)",
              "Define success criteria (e.g., 1 hour saved/week)",
              "Adopt or change tool based on experience"
            ],
            "effort": "M",
            "owner": "Owner",
            "duration_weeks": 6,
            "dependencies": [
              "Automate Simple Tasks with Free Tools"
            ]
          },
          {
            "title": "Document Standard Operating Procedures",
            "why": "Improves consistency, reduces rework and decision fatigue",
            "actions": [
              "Write step-by-step checklists for top 2-3 recurring tasks",
              "Store docs in cloud or local folder",
              "Review each month for updates or improvements"
            ],
            "effort": "M",
            "owner": "Owner",
            "duration_weeks": 6,
            "dependencies": [
              "Template Routine Communications"
            ]
          }
        ],
        "phase_3_long_term": [
          {
            "title": "Consolidate Customer/Business Data in One Place",
            "why": "Prepares for higher-level analysis/AI, and avoids data loss",
            "actions": [
              "Compile spreadsheets, notes, and basic business data into a single file or tool",
              "Back up regularly",
              "Assess what new insights could support business decisions"
            ],
            "effort": "M",
            "owner": "Owner",
            "duration_weeks": 8,
            "dependencies": [
              "Track Key Business Metrics in a Spreadsheet"
            ]
          }
        ]
      },
      ...
      "dynamic_weights_applied": {
        "readiness_avg_adjustment": 0.25,
        "readiness_band_before_uplift": "Emerging",
        "readiness_band_after_uplift": "Emerging",
        "max_strategy_stage_baseline": 2,
        "max_strategy_stage_uplifted": 3,
        "max_strategy_stage_caps": [
          3
        ],
        "max_strategy_stage_final": 3,
        "solopreneur_relaxation": true,
        "small_team_relaxation": false,
        "budget_modifier": true,
        "rural_focus_weighting": false,
        "notes": "Omitting stage-3 (effectiveness) due to low category scores and budget constraints; deferring to later stages when foundational capabilities improve."
      }
    }
  }
}